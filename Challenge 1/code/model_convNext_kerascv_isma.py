...
def train_model():
    ...
    images_train, images_test, labels_train, labels_test = train_test_split(images, labels, test_size=0.20, stratify=np.argmax(labels, axis=1), random_state=seed)
    ...
    def preprocess_data(images, augment=False):
        if augment:
